...
uint16_t Audio_Switcher::update(uint32_t ir) {
    switch (ir) {
        case IR_BUTTON_0: return caller_page;    // Request switch to Monitor Page
        case IR_BUTTON_1: Serial.println("AE0"); return caller_page;    // Request switch to Monitor Page
        case IR_BUTTON_2: Serial.println("AE1"); return caller_page;    // Request switch to Monitor Page
        case IR_BUTTON_3: Serial.println("AE2"); return caller_page;    // Request switch to Monitor Page
        case IR_BUTTON_4: Serial.println("AE3"); return caller_page;    // Request switch to Monitor Page
        case IR_BUTTON_5: Serial.println("AE4"); return caller_page;    // Request switch to Monitor Page
        default: break;
    }
    return UINT16_MAX;
}